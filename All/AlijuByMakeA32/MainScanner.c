...
/* External objects */
extern ali_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
ali_void printScannerError(ali_char* fmt, ...);
ali_void displayScanner(BufferReader* ptrBuffer);
ali_long getScannerFilesize(ali_char* fname);
...
ali_int mainScanner(ali_int argc, ali_char** argv) {
