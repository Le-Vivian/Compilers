 ...
 * -------------------------------------------------------------
 */
ali_void bErrorPrint(ali_char* fmt, ...);
ali_void displayBuffer(BufferReader* ptr_Buffer);
ali_long getFileSize(ali_char* fname);
ali_int isNumber(const ali_char* ns);
ali_void startReader(ali_char*, ali_char*, ali_char, ali_int, ali_int);
...
ali_int mainReader(ali_int argc, ali_char** argv) {

	/* Create source input buffer */
	ali_char* program = argv[0];
	ali_char* input = argv[2];
	ali_char mode = MODE_FIXED;
	ali_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
ali_void startReader(ali_char* program, ali_char* input, ali_char mode, ali_int size, ali_int increment) {

	ReaderPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	ali_int loadSize = 0;		/* the size of the file loaded in the buffer */
	ali_char symbol;			/* symbol read from input file */
...
isNumber(const ali_char* ns) {
	ali_char c; ali_int i = 0;
	if (ns == NULL) return 0;
	while ((c = ns[i++]) == 0) {
